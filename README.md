...
Add Supabase URL and anon_key to the .env file. Run SQL commands in Supabase to create the tables. 
Run ‘npm run dev’ in the project directory to run locally. 
